...
def test_dilated_shapelet_supervised_transform():
    ...
    # fmt: off
    expected = np.array([[
        0.29630489,  44.        ,  36.,           0.18232488,  97.,
       57.        ,   1.58282394, 132.,         100.        ,
    ]])
    # fmt: on
    np.testing.assert_almost_equal(f.transform(X)[:1], expected)
...
def test_competing_dilated_shapelet_supervised_transform():
    ...
    # fmt: off
    expected = np.array([[
       2.79517716,   6.        ,   6.        ,   3.10118429,   3.,
       1.        ,  50.78637862,  25.        ,   3.        ,  27.5667441,
      29.        ,  18.        ,   8.67376659,   9.        ,  11.,
      79.46492513,  53.        ,   8.        ,  44.34552163,  22.,
       5.        ,   9.14099599,   3.        ,  13.        ,  45.05797145,
      31.        ,  16.        ,  22.03220736,  15.        ,  11.,
      48.38316964,  24.        ,  10.        ,   6.37536621,   5.,
       7.        ,  12.07079038,  28.        ,  12.        ,  11.81626848,
      16.        ,  12.        ,   6.72615863,   9.        ,   7.,
      29.06713623,  22.        ,  15.        ,   4.14407542,  11.,
       9.        ,   6.79998137,  20.        ,   9.        ,  24.8230681,
      21.        ,   8.        ,   5.63273987,   4.        ,  12.,
     117.41249373,  44.        ,  16.        ,   7.4643829 ,  17.,
      13.        ,   7.92905134,   7.        ,  11.        ,  60.81964633,
      26.        ,  11.        ,  22.55192706,  31.        ,   0.,
     150.05419053,  44.        ,   3.        ,  68.2379208 ,  16.,
       0.        , 129.33618657,  20.        ,  21.        ,   0.,
      11.        ,  11.        ,   8.38214917,   0.        ,   9.,
       8.84835479,  10.        ,  13.        ,  15.6391129 ,  18.,
      14.        ,
    ]])
    # fmt: on
